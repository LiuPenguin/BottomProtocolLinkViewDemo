...
#define kLoginSDKProtocolLinkSign        @"&" //协议连接符号

#define kLoginSDKProtocolFontTitle       @"同意即表示已阅读" //头文案
...
+ (instancetype)sharedInstance {
    ...
    _sharedInstance.protocolContentBackGroundColor = [UIColor lightGrayColor];
    _sharedInstance.backGroundColor = [UIColor redColor];
    _sharedInstance.protocolContentTextColor = [UIColor redColor];
    _sharedInstance.protocolNormalTextColor = [UIColor orangeColor];
